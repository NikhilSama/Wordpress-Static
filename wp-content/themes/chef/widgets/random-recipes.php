 ...
 *
 */
class Chef_Random_Recipes extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'chef_random_recipes', 'description' => __( "Display random recipes", "chef") );
		parent::__construct('random-recipes', __( "Chef: Random recipes", "chef"), $widget_ops);
		$this->alt_option_name = 'widget_random_recipes';
...
?>
		...
		<?php while ( $r->have_posts() ) : $r->the_post(); ?>
				...
				<?php if ( has_post_thumbnail() ) : ?>
					<div class="recipe-thumb col-md-4 col-sm-4 col-xs-4">
...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of recipes items to show:', 'chef' ); ?></label>
