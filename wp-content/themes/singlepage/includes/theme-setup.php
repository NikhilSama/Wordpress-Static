...
add_action( 'after_setup_theme', 'singlepage_setup' );
 ...
 function singlepage_custom_scripts(){
	...
	wp_enqueue_style( 'singlepage-main', get_stylesheet_uri(), array(), '1.1.6' );
	...
	wp_enqueue_script( 'singlepage-main', get_template_directory_uri().'/js/common.js', array( 'jquery' ), '1.1.6', true );
	...
	$home_side_nav_menu_active_color       = of_get_option("home_side_nav_menu_active_color",'#23dd91');
	if( $blog_menu_hover_color  )
	$singlepage_custom_css     .=  '#featured-template .sub_nav li.cur{color:'.$home_side_nav_menu_active_color.' !important;}';
 ...
 function singlepage_admin_scripts(){
	...
	wp_enqueue_script( 'singlepage-admin', get_template_directory_uri().'/js/admin.js', array( 'jquery' ), '1.1.4', true );
	wp_enqueue_style('singlepage-admin',  get_template_directory_uri() .'/css/admin.css', false, '1.1.4', false);
	 }
  }
